...
class Iconic_Blog_Block_Adminhtml_Comment_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if ( Mage::registry('blog_data') && Mage::registry('blog_data')->getId() ) {
            return Mage::helper('blog')->__("Edit Comment By '%s'",
                $this->htmlEscape(Mage::registry('blog_data')->getUser()));
        } else {
