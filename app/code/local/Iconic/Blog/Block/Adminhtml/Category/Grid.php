...
class Iconic_Blog_Block_Adminhtml_Category_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $tableName = Mage::getSingleton('core/resource')->getTableName('blog_category_store');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('title', array(
            ...
            'align'     =>'left',
            'index'     => 'title',
            'renderer' => 'blog/adminhtml_category_grid_column_renderer_subCategories',
        ));
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    ...
                    array(
                        'caption'   => Mage::helper('blog')->__('Add Sub Category'),
                        'url'       => array('base'=> '*/*/new'),
                        'field'     => 'parent_id'
                    )
                ...
                'filter'    => false,
                'sortable'  => false,
                'renderer' => 'blog/adminhtml_category_grid_column_renderer_action',
                ));
