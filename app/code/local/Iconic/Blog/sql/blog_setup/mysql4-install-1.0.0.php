...
INSERT INTO {$this->getTable('blog/blog')} VALUES (NULL, 'Welcome to ICONIC blog', 'test', 'This is a short content', 'This is a content', '', '', '', '0', '0', '', '1', NOW( ), NOW( ), NOW( ), NULL, NULL, 'Test author', 'Meta Keywords', 'Meta Description', '0', '0', '0', '0', '0', '', '', NULL, NULL, NULL, NULL);

DROP TABLE IF EXISTS {$this->getTable('blog/comment')};
CREATE TABLE {$this->getTable('blog/comment')} (
    `comment_id` int( 11 ) unsigned NOT NULL AUTO_INCREMENT ,
    `blog_id` smallint( 11 ) NOT NULL default '0',
...
INSERT INTO {$this->getTable('blog/comment')} (`comment_id` ,`blog_id` ,`comment` ,`comment_status` ,`created_time` ,`user` ,`email`)
...
INSERT INTO {$this->getTable('blog/category')} (
    `category_id` ,
    `title`,
    `url_key`
)
...
DROP TABLE IF EXISTS {$this->getTable('blog/blog_store')};
CREATE TABLE {$this->getTable('blog/blog_store')} (
    `blog_id` smallint(6) unsigned,
    `store_id` smallint(6) unsigned
) ENGINE = InnoDB DEFAULT CHARSET = utf8;

DROP TABLE IF EXISTS {$this->getTable('blog/category_store')};
CREATE TABLE {$this->getTable('blog/category_store')} (
    `category_id` smallint(6) unsigned ,
    `store_id` smallint(6) unsigned
) ENGINE = InnoDB DEFAULT CHARSET = utf8;

DROP TABLE IF EXISTS {$this->getTable('blog/blog_category')};
CREATE TABLE {$this->getTable('blog/blog_category')} (
    `category_id` smallint(6) unsigned ,
    `blog_id` smallint(6) unsigned
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
");
