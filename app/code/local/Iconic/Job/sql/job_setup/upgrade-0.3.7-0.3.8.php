...
-- DROP TABLE IF EXISTS {$this->getTable('job/listcountry')};
CREATE TABLE {$this->getTable('job/listcountry')} (
  `listcountry_id` int(11) unsigned NOT NULL auto_increment,
  `name` varchar(255) NOT NULL default '',
  `name_en` varchar(255) NOT NULL default '',
  PRIMARY KEY (`listcountry_id`)
