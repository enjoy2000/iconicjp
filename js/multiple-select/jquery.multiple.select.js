...
(function($) {
    ...
    function MultipleSelect($el, options) {
		...
		if($el.attr('required')){
			this.$parent = $('<div class="ms-parent required '+$el.attr('class')+'"></div>');
		}else{
			this.$parent = $('<div class="ms-parent '+$el.attr('class')+'"></div>');
		}
    ...
    MultipleSelect.prototype = {
        ...
        close: function() {
            ...
            this.$choice.addClass('after-input');
            if (this.options.container) {
                this.$parent.append(this.$drop);
                this.$drop.css({
                    'top': 'auto',
